    ...
    <div id="rev_slider_4_1" class="rev_slider" style="display:none;" data-version="5.0.7">
        <ul>
            ...
            <li data-index="rs-{{ $loop->iteration }}"
                ...
                <!-- MAIN IMAGE -->
                <img data-lazyload="{!! $slide->present()->firstImage(1280,500,'fit',70) !!}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYER NR. 2 -->
