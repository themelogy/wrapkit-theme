<div class="container locations">
    <div class="row">
        <div class="col-md-6">
            <h3 class="fs-sm-12">{{ trans('themes::location.title.offices') }}</h3>
        </div>
        <div class="col-md-6">
                    ...
                    <div class="office-desc">
                        ...
                        @if($location->phone1)
                            <div class="d-flex no-block">
                                ...
                                <div class="info">
                                    <span class="font-medium db m-t-5"><a rel="nofollow" class="text-themecolor" href="tel:{{ $location->phone1 }}">{{ $location->phone1 }}</a></span>
                                </div>
                            </div>
                        @endif
                        @if($location->fax)
