<?php namespace Themes\Moderna\Presenter;

use Nwidart\Menus\Presenters\Presenter;

class FooterMenuPrefixedLinksPresenter extends Presenter
{
    /**
     * {@inheritdoc }.
     */
    ...
    {
        return PHP_EOL.'<ul class="dropdown-menu" role="menu">'.PHP_EOL;
    }
    ...
    {
        return '<li'.$this->getActiveState($item).'><a href="'.$item->getUrl().'" '.$item->getAttributes().'>'.$item->getIcon().' <i class="fa fa-angle-right m-rgt-10"></i>'.$item->title.'</a></li>'.PHP_EOL;
    }
